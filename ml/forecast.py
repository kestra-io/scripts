...
parser = argparse.ArgumentParser(
    description="Run the forecasting script using scikit-learn and XGBoost."
)

parser.add_argument(
    "--days",
    type=int,
    help="The number of days to forecast.",
    default=30,
)
parser.add_argument(
    "--file_path",
...
plt.scatter(
    filtered_future_df["ds"],
    filtered_future_df["yhat_lr"],
    color="red",
    label="LR Forecast",
    marker="x",
    s=10,
